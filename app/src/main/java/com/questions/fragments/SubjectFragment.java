...
public class SubjectFragment extends BaseFragment<FragSubjectOneBinding>{
    ...
    protected void init() {
        ...
        mBinding.banner.setPages(new CBViewHolderCreator<BannerAdapter>(){
    ...
    protected void initEvent(Bundle savedInstanceState) {
        mBinding.lvnExam.setOnClickListener(new View.OnClickListener() {//模拟考试
            @Override
            public void onClick(View v) {//模拟考试
        ...
        mBinding.lvnPractice.setOnClickListener(new View.OnClickListener() {//章节练习
            @Override
        ...
        mBinding.lvnCollection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mBinding.lvnError.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
